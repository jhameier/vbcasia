...
public final class StudentDisplayForm extends JPanel {
  ...
  public StudentDisplayForm() {
    setLayout(new MigLayout("",
        "[grow][90px][20px][40px][10px][80px][10px][30px][10px][80px][10px][60px][10px][80px][10][80px][10px,grow]",
        "[20px,grow][20px][20px][25px][20px][][20px][20px][25px][20px][][20px][20px][20px][][20px][20px][][20px][25px][25px][25px][25px][20px,grow]"));
