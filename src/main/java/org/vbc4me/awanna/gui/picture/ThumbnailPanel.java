...
public class ThumbnailPanel extends JPanel {
	...
	/**
	 * Updated the displayed thumbnail and attaches an {@link ImageContainer image container} containing
	 *   the original image with a thumbnail for additional processing.
	 */
