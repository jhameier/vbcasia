 ...
 * with where the thumbnail is in relation to the parent image.
 *
 * <p> This container's data is immutable. You can obtain cloned copies of the data, but you must create a new
 * {@link Photo} one if you want to make changes.
 */
public final class Photo {
   ...
   */
  public Photo(BufferedImage primaryImage, BufferedImage thumbnail) {
    this(primaryImage, thumbnail, new Rectangle(100, 100, 100, 100));
  }

  public Photo(BufferedImage image, BufferedImage thumbnail, Rectangle2D boundingBox) {
  ...
  /**
   * Returns an empty {@link Photo Image Container} with an Alpha enabled image and thumbnail.
   */
  public static Photo intializeEmptyContainer() {
