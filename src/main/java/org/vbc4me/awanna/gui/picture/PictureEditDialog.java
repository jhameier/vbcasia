...
public class PictureEditDialog extends JDialog {
  ...
  /**
   * Constructs a new dialog that allows the creation of a thumbnail image used to display within some panel. All images
   * needed to create and store the thumbnail are provided by the {@link ThumbnailPanel panel} passed in.
   */
