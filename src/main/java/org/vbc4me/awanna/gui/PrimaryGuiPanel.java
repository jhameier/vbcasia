...
public class PrimaryGuiPanel extends JFrame {
  ...
  /**
   * Change the card layout for this applications button layout. Currently available button
   * layouts are: SeasonButtonPanel, SessionButtonPanel and RecordButtonPanel. You call
   * PrimaryGuiPanel.getButtonLayout().
   */
  ...
  /**
   * Gets the primary display panel for this application. This is used to display different
   * displays in this window without having to create them within the GUI itself. You can create
   * different panels and call them from an Action and replace the panels to the primary display.
   */
