...
public class PhoneNumber {
  ...
  /**
   * Represents a persons phone number. The number should be in its raw form such as 1234567890 and should contain 10
   * numeric digits. <p> <p> If any of the following conditions are not met, this constructor will throw and {@link
   * IllegalArgumentException}: The input is not exactly 10 digits The input contains any character that is not numeric
   * <p> <p> The type is used to classify the number such as home or cell or office etc.
   */
  ...
  /**
   * Returns true if the phone number is removed from the list of phone numbers otherwise returns false. The number can
   * be formatted as xxx-xxx-xxxx or (xxx) xxx-xxxx or unformatted xxxxxxxxxx.
   */
  ...
  /**
   * Returns a {@link String} with the type and phone number for use in displaying a well formated output in the form
   * of: <p> <p> Number Type : (123) 456-7890
   */
