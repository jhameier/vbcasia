...
public class TestTransaction {
	...
	public void TestDebitTransaction() {
		Activity debitActivity = Activity.builder().name("Debit").description("debit").cost(1.52).date(date).time(time).create();
	...
	public void TestCreditTransaction() {
		Activity creditActivity = Activity.builder().name("Credit").description("credit").cost(6.95).date(date).time(time).create();
	...
	public void TestTransactionActivity() {
		Activity activity = Activity.builder().name("Debit").description("debit").cost(16.84).date(date).time(time).create();
